...
<head>
    ...
    <script>
        // Function to handle the size modal opening
...
<body>
    ...
    <!-- Floating cart button -->
    <a href="#" class="floating-cart"><i class="bi bi-cart"></i></a>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#sizeModal" data-prod-id="<?php echo $product['prodID']; ?>" data-prod-name="<?php echo $product['prodName']; ?>" data-price="<?php echo number_format($product['price'], 2); ?>">
                                    Buy Now
                                </a>
                            </div>
                        </div>
